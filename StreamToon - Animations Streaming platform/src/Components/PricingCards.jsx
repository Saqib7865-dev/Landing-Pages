...
const PricingCards = () => {
  return (
    <section
      id="about"
      className="pt-10 pb-10 px-10 bg-gradient-to-r from-amber-600 to-indigo-600 w-full"
    >
      <h2 className="text-center text-white text-5xl uppercase font-semibold font-mono">
        Price Structure
      </h2>
      <div className="cards-container grid grid-cols-3 gap-6 pt-16">
        <div className="card1 rounded shadow bg-white px-10 py-5">
          <h4 className="text-2xl font-serif font-bold">
            Get Started - $0/month
          </h4>
          <ul className="py-16 flex flex-col space-y-3">
            ...
            <li className="font-serif text-lg text-justify">
              No{" "}
              <span className="font-semibold text-lg font-serif">Offline</span>{" "}
              Downloads
            </li>
            <li className="font-serif text-lg text-justify">
              <span className="font-semibold text-lg font-serif">
        ...
        <div className="card2 rounded shadow bg-white px-10 py-5">
          <h4 className="text-2xl font-serif font-bold">
        ...
        <div className="card3 rounded shadow bg-white px-10 py-5">
          <h4 className="text-2xl font-serif font-bold">
